        ...
        {threats.map((threat) => (
          <div key={threat.id} className="px-6 py-4">
            ...
            <div className="mt-4 flex space-x-4">
              <button className="bg-red-500 text-white px-4 py-2 rounded">Deauth Attack</button>
              <button className="bg-blue-500 text-white px-4 py-2 rounded">Packet Analysis</button>
            </div>
          </div>
        ))}
      </div>
